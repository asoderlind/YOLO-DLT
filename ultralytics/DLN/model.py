...
class DLN(nn.Module):
    def __init__(self, input_dim=3, dim=64):
        ...
        self.feat_out_2 = LBP(input_size=2 * dim, output_size=dim, kernel_size=3, stride=1, padding=1)
        self.feat_out_3 = LBP(input_size=3 * dim, output_size=dim, kernel_size=3, stride=1, padding=1)
