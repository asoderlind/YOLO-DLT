...
if __name__ == "__main__":
    classes = 0
    run_seeded_train(
        name="waymo_dark-yolo11n-bic-repc3k2-se",
        model="dlt-models/yolo11n-bic-repc3k2-se.yaml",
        data="waymo_dark.yaml",
    )
    run_seeded_train(
        name="waymo_dark-yolo11n-bic-repc3k2-eca",
        model="dlt-models/yolo11n-bic-repc3k2-eca.yaml",
        data="waymo_dark.yaml",
    )
    run_seeded_train(
        name="waymo_dark-yolo11n-bic-repc3k2-simam",
        model="dlt-models/yolo11n-bic-repc3k2-simam.yaml",
        data="waymo_dark.yaml",
    )
    run_seeded_train(
        name="waymo_dark-yolo11n-bic-repc3k2-ca",
