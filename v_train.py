...
if __name__ == "__main__":
    ...
    train_model_v(
        name="waymo_dark-yolo11n-40_e-16_gframe-no-mosaic",
    ...
    train_model_v(
        name="waymo_dark-yolo11n-40_e-16_lframe-no-mosaic",
        model="dlt-models/yolo11n-temporal-nms-0.75.yaml",
        model_load_path=WAYMO_TEMPORAL_BASE,
        data="waymo_dark.yaml",
        # gframe=16,
    ...
    train_model_v(
        name="waymo_dark-yolo11n-80_e-16_gframe",
        model="dlt-models/yolo11n-temporal-nms-0.75.yaml",
        model_load_path=WAYMO_TEMPORAL_BASE,
        data="waymo_dark.yaml",
        gframe=16,
    ...
    # train_model_v(
    #     name="waymo_dark-yolo11n-40_e-16_gframe-0.005_lr0-0.75_nms-temporal_dl-25.0_attn_scale-fixed-no-sigmoid",
    #     model="dlt-models/yolo11n-temporal-nms-0.75.yaml",
    #     model_load_path=WAYMO_TEMPORAL_BASE,
    #     data="waymo_dark.yaml",
    #     gframe=16,
